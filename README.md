...
(i) "Perovs-IAP": ./Perovs-IAP_finetuned_bulk+defect+surface_2025_PES (fine-tuned on bulk+defects+surfaces ~12,000 structures, RECOMMENDED for downstream tasks such ABX3 alloys, point defects and slabs in CsGeX3 and FAPI) <br>
...
(iii) ./Additional_fine-tuned_IAPs/Perovskites_2025_PES_Initial_dataset (trained on the whole dataset without any sampling ~37,200 structures)(NOTE - Better for new phase explorations and decomposition pathways!) <br>
